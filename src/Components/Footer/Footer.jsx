                                    ...
                                    <div className="footer-widget footer-about-widget mb-40 pf_fadeup">
                                        <div className="footer-content">
                                            <div className="footer-logo">
                                                <a href="#"><img src="/assets/images/creative-agency/logo/logo-main.png" alt="Brand Logo" /></a>
                                            </div>
                                            <p>Eternity creative digital agency delivering innovate web Development marketing.</p>
                                            <form>
                                                ...
                                                <div className="footer-content">
                                                    ...
                                                    <div className="agenko-iconic-box style-three mb-30">
                                                        ...
                                                        <div className="content">
                                                            <h6>Email</h6>
                                                            <p><a href="mailto:info@agenko.com">contact@eternitytech.com</a></p>
                                                        </div>
                                                    </div>
                                                    <div className="agenko-iconic-box style-three">
                                                        ...
                                                        <div className="content">
                                                            <h6>Phone</h6>
                                                            <p><a href="tel:+91-6207374918">+91 6207374918</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <div className="copyright-text">
                                        <p>&copy; 2025 <span>Eternity</span> - All Rights Reserved.</p>
                                    </div>
                                </div>
                                <div className="col-md-6">
